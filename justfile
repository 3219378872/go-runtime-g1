...
project_go_files := "alloc.go config.go cset.go cycle.go doc.go errors.go evac.go g1gc_test.go heap.go id.go mark.go object.go policy.go refs.go region.go rset.go snapshot.go stats.go sweep.go validate.go cmd/g1gc-demo/main.go bench/compare/main.go bench/workload/main.go"
