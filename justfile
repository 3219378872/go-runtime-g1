...
project_go_files := "alloc.go bench_sim_test.go config.go cset.go cycle.go cycle_test.go doc.go errors.go evac.go evac_test.go heap.go id.go mark.go mark_test.go object.go policy.go policy_test.go pool.go pool_test.go refs.go region.go rset.go rset_test.go sim_test.go snapshot.go stats.go sweep.go validate.go cmd/g1gc-demo/main.go bench/compare/main.go bench/workload/main.go"
