...
- 根模拟包（`alloc.go, config.go, cset.go, cycle.go, doc.go, errors.go, evac.go, heap.go, id.go, mark.go, object.go, policy.go, refs.go, region.go, rset.go, snapshot.go, stats.go, sweep.go, validate.go`，地图见 `doc.go`/M01）：算法验证与行为回归，可 O(heap)。入口 `README.md:21-26,61-65`（`go test` + `cmd/g1gc-demo`）。
