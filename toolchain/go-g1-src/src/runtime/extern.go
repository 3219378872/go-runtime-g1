...
It is a comma-separated list of name=val pairs setting these named variables:
	...
	g1gc: setting g1gc=1 enables the experimental G1 features in the
	go-runtime-g1 toolchain fork. Region accounting and cycle hooks are activated
	when g1trace, g1gcset, or g1evac consumes them.

	g1gcset: setting g1gcset=1 enables the experimental collection-set scheduler
	that prioritizes low-live spans during concurrent sweeping. It requires
	g1gc=1 and does not evacuate or move objects.

	g1trace: setting g1trace=1 appends experimental G1 region and evacuation
	statistics to gctrace output. It requires g1gc=1.
