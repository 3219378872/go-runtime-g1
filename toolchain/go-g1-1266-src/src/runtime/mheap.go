...
type mspan struct {
	...
	g1evacDest     *mspan
	g1evacNext     *mspan
	g1rewriteEpoch uint64
	g1rewriteNext  *mspan
	// Number of live objects copied out of this span. The source span's
	// ordinary allocCount is reduced by this amount before sweep so the
	// standard totalFree accounting records dead objects only; G1's used
	// accounting consumes this field to remove the complete source span.
	g1evacLiveObjects uint16
}
...
func (span *mspan) init(base uintptr, npages uintptr) {
	...
	span.g1evacDest = nil
	span.g1evacNext = nil
	span.g1rewriteEpoch = 0
	span.g1evacLiveObjects = 0
